...
$src = [System.Drawing.Image]::FromFile('c:\Users\monde\Goon WarfareX\Assets\Ramon ang.jpg')
$W = $src.Width; $H = $src.Height
Write-Host "Image: ${W}x${H}"

# Try 4col x 4row first
$cols=4; $rows=4
$tw = [int]($W/$cols); $th = [int]($H/$rows)
Write-Host "Tile size 4c x 4r: ${tw}x${th}"

$outDir = 'c:\Users\monde\Goon WarfareX\Assets\_ramon_tiles'
